  ...
  <Fragment>
    ...
    <div className="body">
      <p className="description">
        ...
        Viscira. The requirements from the client was unique. They had their own
        enterprsie iPad container that could accept webpages. I recommended that
        we use Angular 2 with the CLI to quickly build out the pages and router
        needed to move between the nav and subnavpages.
      </p>
      <div className="screenshots">
        ...
        <img className="col" src={BiomarinCaseStudyWithWrongAnswer} alt="" />
