...
<Columns>
    ...
    <section className="hero">
      ...
      <div className="hero-content">
        ...
        <p>
          My focus was to implement the{' '}
          <NavLink to="/projects/etrade">user interface designs.</NavLink>
        </p>
        <p>
        ...
        <div>
          <p>
            I worked on various B2B websites and mobile applications that are
            used for:
          </p>
          ...
          <ol>
            <li>
              <p>
                B2B sales from medical companies to medical doctors and
                hospitals.
              </p>
            </li>
            <li>
          ...
          <ol>
            <li>
              <p>
                ...
                information, which requires following strict Federal
                regulations. The FDA prior to release inspected all finished
                applications.
              </p>
            </li>
            <li>
