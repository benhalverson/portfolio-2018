...
const JazzErwinaze = () => (
  <Fragment>
    ...
    <div className="body">
      <p>
        This was a unique project becuae it took two different solutions that
        Viscira provided and combined them into one. I mostly worked on the
        Casebuilder part of this application.
      </p>
